      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="card flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-accent">
                  {wallet ? formatCurrency(Number(wallet.kesBalance) - Number(wallet.lockedBalance)) : 'KES 0.00'}
                </p>
              </div>
            </div>
            <div className="card flex items-center gap-4">
            ...
            <div className="card flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-accent capitalize">{user?.kycStatus ?? 'None'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <a href="/markets" className="text-sm text-primary font-medium hover:underline">View all →</a>
          </div>

          {markets.length === 0 ? (
            <div className="card text-center py-12">
              <p className="text-muted">No open markets yet.</p>
              <a href="/markets" className="btn-primary mt-4 inline-block">Browse Markets</a>
            </div>
          ) : (
